...
public abstract class HttpUtils {
     ...
     //ArrayList<NameValuePair> keyValueArray
	{
		...
		responseStatus.mStatus = Constants.RESPONSE_STATUS_OK;
		...
		try{
			...
			responseStatus.mStatus = Constants.RESPONSE_STATUS_TIMEOUT;
		}catch(ClientProtocolException e){
			responseStatus.mStatus = Constants.RESPONSE_STATUS_PRO_ERROR;
		}catch(IOException e){
			responseStatus.mStatus = Constants.RESPONSE_STATUS_IO_ERROR;
		}finally{
