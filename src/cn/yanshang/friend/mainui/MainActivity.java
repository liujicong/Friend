...
public class MainActivity extends FragmentActivity implements OnClickListener {
	...
	// Drawable myImage =
	// getResources().getDrawable(R.drawable.img_main_friend);
	// rbMainLender.setCompoundDrawablesWithIntrinsicBounds(null, myImage, null,
	// null);
	// }
	...
	private void setCurrectTable(int key) {
		...
		case MAIN_LENDER:
			...
			// Drawable myImage =
			// getResources().getDrawable(R.drawable.img_main_friend);
			// rbMainLender.setCompoundDrawablesWithIntrinsicBounds(null,
			// myImage, null, null);
	...
	public void onBackPressed() {
		// TODO Auto-generated method stub
		if (fMgr.findFragmentByTag("FragmentMainLender") != null
				&& fMgr.findFragmentByTag("FragmentMainLender").isVisible()) {
