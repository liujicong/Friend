...
public interface Constants {
	...
	//public static final String URL_POST_VALID_PHONE = "http://app.ylcdev.tk/api/user/valid-phone";
	...
	public static final int HTTP_STATUS_FORMAT_ERROR = 10004;//数据格式错误
	public static final int HTTP_STATUS_ACCOUNT_ERROR = 10004;//账号不正确
	public static final int HTTP_STATUS_PASSWORD_ERROR = 10005;//密码错误   frequently
